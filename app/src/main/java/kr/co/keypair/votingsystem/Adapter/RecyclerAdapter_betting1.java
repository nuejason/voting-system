...
public class RecyclerAdapter_betting1 extends RecyclerView.Adapter<RecyclerAdapter_betting1.ItemViewHolder> {
    ...
    public RecyclerAdapter_betting1(Context context, int resource) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_betting1,parent,false);
