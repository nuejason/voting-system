...
public class ENG extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("ENG");
        player.moveToFirst();
        ...
        Cursor country = mDbHelper.Country("ENG");
        country.moveToFirst();

        country_flag = (ImageView)v.findViewById(R.id.country_flag);
        country_name = (TextView)v.findViewById(R.id.country);
        country_flag.setImageResource(R.drawable.eng);
        country_name.setText("잉글랜드");
