...
public class CRO extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("CRO");
        player.moveToFirst();
        ...
        Cursor country = mDbHelper.Country("CRO");
        country.moveToFirst();

        country_flag = (ImageView)v.findViewById(R.id.country_flag);
        country_name = (TextView)v.findViewById(R.id.country);
        country_flag.setImageResource(R.drawable.cro);
        country_name.setText("크로아티아");
