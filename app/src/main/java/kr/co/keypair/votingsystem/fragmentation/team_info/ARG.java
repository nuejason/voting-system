...
public class ARG extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("ARG");
        player.moveToFirst();
        ...
        Cursor country = mDbHelper.Country("ARG");
        country.moveToFirst();

        country_flag = (ImageView)v.findViewById(R.id.country_flag);
        country_name = (TextView)v.findViewById(R.id.country);
        country_flag.setImageResource(R.drawable.arg);
        country_name.setText("아르헨티나");
