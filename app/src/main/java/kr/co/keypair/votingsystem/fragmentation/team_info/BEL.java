...
public class BEL extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("BEL");
        player.moveToFirst();
        ...
        Cursor country = mDbHelper.Country("BEL");
        country.moveToFirst();

        country_flag = (ImageView)v.findViewById(R.id.country_flag);
        country_name = (TextView)v.findViewById(R.id.country);
        country_flag.setImageResource(R.drawable.bel);
        country_name.setText("벨기에");
