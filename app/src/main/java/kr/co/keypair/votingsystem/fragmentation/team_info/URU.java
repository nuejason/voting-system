...
public class URU extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("URU");
        player.moveToFirst();
        ...
        Cursor country = mDbHelper.Country("URU");
        country.moveToFirst();

        country_flag = (ImageView)v.findViewById(R.id.country_flag);
        country_name = (TextView)v.findViewById(R.id.country);
        country_flag.setImageResource(R.drawable.uru);
        country_name.setText("우루과이");
