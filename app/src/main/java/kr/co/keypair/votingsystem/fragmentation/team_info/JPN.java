...
public class JPN extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("JPN");
        player.moveToFirst();
