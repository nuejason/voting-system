...
public class SUI extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("SUI");
        player.moveToFirst();
        ...
        Cursor country = mDbHelper.Country("SUI");
        country.moveToFirst();

        country_flag = (ImageView)v.findViewById(R.id.country_flag);
        country_name = (TextView)v.findViewById(R.id.country);
        country_flag.setImageResource(R.drawable.sui);
        country_name.setText("스위스");
