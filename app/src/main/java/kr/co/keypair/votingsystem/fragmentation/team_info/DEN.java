...
public class DEN extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor player = mDbHelper.Player("DEN");
        player.moveToFirst();
        ...
        Cursor country = mDbHelper.Country("DEN");
        country.moveToFirst();

        country_flag = (ImageView)v.findViewById(R.id.country_flag);
        country_name = (TextView)v.findViewById(R.id.country);
        country_flag.setImageResource(R.drawable.den);
        country_name.setText("덴마크");
